...
size(empty) -> 0;
size({L, _, _, R}) -> size(L) + size(R) + 1;
size({L, _, _, M, _, _, R}) -> size(L) + size(M) + size(R) + 2.
...
%"Up" node
store_aux(Key, Val, empty) ->
    {up, empty, Key, Val, empty};
...
%Key == Xk
store_aux(_, Val, {L, Xk, _, M, Yk, Yv, R}) ->
    {L, Xk, Val, M, Yk, Yv, R}.
...
%Key == Xk
update_val(_, Val, {L, Xk, _, M, Yk, Yv, R}) ->
    {L, Xk, Val, M, Yk, Yv, R}.
...
%Key == Xk
update(_, Fun, {L, Xk, Xv, M, Yk, Yv, R}) ->
...
update_aux(Key, _, I, empty) ->
    {up, empty, Key, I, empty};
...
%Key == Xk
update_aux(_, Fun, _, {L, Xk, Xv, M, Yk, Yv, R}) ->
    {L, Xk, Fun(Xv), M, Yk, Yv, R}.
...
update_counter_aux(Key, I, empty) ->
    {up, empty, Key, I, empty};
...
%Key == Xk
update_counter_aux(_, I, {L, Xk, Xv, B, Yk, Yv, R}) ->
    {L, Xk, Xv + I, B, Yk, Yv, R}.
...
%1.1
erase_up2_l({up, L}, Xk, Xv, {M, Yk, Yv, R}) ->
    {up, {L, Xk, Xv, M, Yk, Yv, R}};
%2.1
erase_up2_l({up, A}, Xk, Xv, {B, Yk, Yv, C, Zk, Zv, D}) ->
    {{A, Xk, Xv, B}, Yk, Yv, {C, Zk, Zv, D}};
erase_up2_l(L, K, V, R) ->
    {L, K, V, R}.

%1.2
erase_up2_r({L, Xk, Xv, M}, Yk, Yv, {up, R}) ->
    {up, {L, Xk, Xv, M, Yk, Yv, R}};
%2.2
erase_up2_r({A, Xk, Xv, B, Yk, Yv, C}, Zk, Zv, {up, D}) ->
    {{A, Xk, Xv, B}, Yk, Yv, {C, Zk, Zv, D}};
erase_up2_r(L, K, V, R) ->
    {L, K, V, R}.
...
%3a.1
erase_up3_l({up, A}, Xk, Xv, {B, Yk, Yv, C}, Zk, Zv, D) ->
    {{A, Xk, Xv, B, Yk, Yv, C}, Zk, Zv, D};
%4a.1
erase_up3_l({up, A}, Wk, Wv, {B, Xk, Xv, C, Yk, Yv, D}, Zk, Zv, E) ->
    {{A, Wk, Wv, B}, Xk, Xv, {C, Yk, Yv, D}, Zk, Zv, E};
erase_up3_l(A, Xk, Xv, B, Yk, Yv, C) ->
    {A, Xk, Xv, B, Yk, Yv, C}.

%3a.2
erase_up3_m({A, Xk, Xv, B}, Yk, Yv, {up, C}, Zk, Zv, D) ->
    {{A, Xk, Xv, B, Yk, Yv, C}, Zk, Zv, D};
%3b.1
erase_up3_m(A, Xk, Xv, {up, B}, Yk, Yv, {C, Zk, Zv, D}) ->
    {A, Xk, Xv, {B, Yk, Yv, C, Zk, Zv, D}};
%4a.2
erase_up3_m({A, Wk, Wv, B, Xk, Xv, C}, Yk, Yv, {up, D}, Zk, Zv, E) ->
    {{A, Wk, Wv, B}, Xk, Xv, {C, Yk, Yv, D}, Zk, Zv, E};
%4b.1
erase_up3_m(A, Wk, Wv, {up, B}, Xk, Xv, {C, Yk, Yv, D, Zk, Zv, E}) ->
    {A, Wk, Wv, {B, Xk, Xv, C}, Yk, Yv, {D, Zk, Zv, E}};
erase_up3_m(A, Xk, Xv, B, Yk, Yv, C) ->
    {A, Xk, Xv, B, Yk, Yv, C}.

%3b.2
erase_up3_r(A, Xk, Xv, {B, Yk, Yv, C}, Zk, Zv, {up, D}) ->
    {A, Xk, Xv, {B, Yk, Yv, C, Zk, Zv, D}};
%4b.2
erase_up3_r(A, Wk, Wv, {B, Xk, Xv, C, Yk, Yv, D}, Zk, Zv, {up, E}) ->
    {A, Wk, Wv, {B, Xk, Xv, C}, Yk, Yv, {D, Zk, Zv, E}};
