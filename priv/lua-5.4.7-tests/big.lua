...
print("NOT testing large table (~2^18 elements)")
local lim = 2^18 + 1000
--local prog = { "local y = {0" }
-- Shell hang - not clear if a genuine hang or just a very long test
...
print("NOT testing yields during accesses larger than K (in RK) via coroutines")
--setmetatable(env, {
