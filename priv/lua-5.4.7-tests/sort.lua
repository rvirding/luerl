...
-- TODO: Rewrite this test with Luerl in mind - it's a useful test but
--       checkerror doesn't work in Luerl because of how errors are 
--       returned
print("NOT testing wrong number of arguments")
--checkerror("wrong number of arguments", table.insert, {}, 2, 3, 4)

print("testing unpack with various arguments")
local x,y,z,a,n
...
-- TODO: Shell hang
print("NOT testing unpack with min/max int values and overflow")
--do
...
print("NOT testing table lengths are not integers")
...
print("NOT testing sort with strange lengths")
---- strange lengths
...
print("NOT testing checks for invalid order functions")
