...
print("testing invalid operations should not raise errors when not executed")
...
print("NOT testing operators with differnt kinds of constants")
...
print("NOT testing multiple return values in boolean expression")
-- TODO: Assertion failed
--local a,b = 3 and f();
--assert(a==1 and b==nil)

print("testing explicit empty returns nil")
function g() f(); return; end;
assert(g() == nil)

print("NOT testing expression preserves first return value")
-- TODO: Assertion failed
...
print("NOT testing variable attributes")
-- TODO: {lua_error, {badarg, find, [nil, <<"unknown attribute 'XXX'">, %.. 
...
print("testing complex boolean expressions with forced line breaks")
f = [[
...
print("testing boolean expression evaluation across different control structures")
...
print("testing nil literal in conditional")
do
  local a; if nil then a=1; else a=2; end;    -- this nil comes as PUSHNIL 2
  assert(a==2)
end

print("NOT testing comparison operators with multiple returns")
-- TODO: debug.getinfo() unimplemented
--local function F (a)
...
print("NOT testing short-circuit optimizations")
...
print("testing boolean expression generation")
...
print("NOT testing constant folding with boolean expressions")
-- TODO: lua_error,{badarg,ipairs,[nil,0]}, ... 
