...
print("NOT testing garbage collection behavior")
--local a = f(10)
...
print("testing closures x break")
do
  local X, Y
  local a = math.sin(0)
...
--TODO: Luerl doesn't support yet gotos 
print("NOT testing closures created in 'then' and 'else' parts of 'if's")
--a = {}
--for i = 1, 10 do
--  if i % 3 == 0 then
--    local y = 0
...
print("testing for correctly closing upvalues in tail calls of vararg functions")
local function t ()
...
print("NOT testing for debug manipulation of upvalues")
...
--sert(debug.upvalueid(foo1, 1) ~= debug.upvalueid(foo3, 1))
