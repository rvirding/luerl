...
print("testing string.find() operations")
...
print("testing string.match() operations")
...
print('testing adapting patterns to UTF-8')
local function PU (p)
...
print("NOT testing pattern matching with position capture")
...
print("testing char set extraction")
...
print("testing string.match() edge cases")
...
assert(string.gsub("abc=xyz", "(%w*)(%p)(%w+)", "%3%2%1-%0") ==
              "xyz=abc-abc=xyz")
print("NOT testing gsub with %1 and %0 replacements")
...
print("NOT testing 5.3.3 semantics for empty matches")
--do
...
print("testing string.gsub() with function replacement")
assert(string.gsub("um (dois) tres (quatro)", "(%(%w+%))", string.upper) ==
            "um (DOIS) tres (QUATRO)")

print("testing string.gsub with function to set global vars")
do
...
print("testing nested string.gsub with replacement function")
function f(a,b) return string.gsub(a,'.',b) end
assert(string.gsub("trocar tudo em |teste|b| é |beleza|al|", "|([^|]*)|([^|]*)|", f) ==
            "trocar tudo em bbbbb é alalalalalal")

print("testing string.gsub with embedded code execution")
...
print("testing position captures and word splitting")
local t = {}
...
print("testing balanced pattern matching")
...
print("NOT testing error messages on failed replacements")
...
print("testing recursive nest of gsubs")
...
print("NOT testing 'unfinished capture' message")
--malform("(.", "unfinished capture")
print("NOT testing 'invalid pattern capture' message")
...
malform("%ba")
malform("%")
print("NOT testing 'missing' message")
--malform("%f", "missing")

-- \0 in patterns
print("testing \\0 in patterns")
...
print("NOT testing reuse of original string in gsub")
-- TODO: 
--{badarg,format,
--        [<<"%p">>,
