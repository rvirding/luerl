...
-- debug.getupvalue not implemented
...
-- TODO: See getenv
print("NOT testing load in global environment")
--assert(getenv(load"a=3") == _G)
print("NOT testing load in table")
-- TODO: {badarg,load,[<<"a = 3">>,nil,nil,{tref,17}]}
...
print("NOT testing limits for special instructions")
--do
--  local i = 2
--  local p = 4    -- p == 2^i
--  repeat
...
--    end
--    p = 2 * p;  i = i + 1
--  until p <= 0 -- TODO: Overflow doesn't work quite the same in Luerl?
--               -- {badarith,'^',[2,1024]}
--end

print'+'

print("testing clearing of dead elements from tables")
if rawget(_G, "T") then
...
print("NOT testing lexical environments")
--assert(_ENV == _G)
...
print("NOT testing environmental variable isolation")
--assert(getenv(foo) == mt)
--x = foo('hi'); assert(mt.A == 'hi' and A == 1000)
print("NOT testing closure captures defining environment")
--assert(x('*') == mt.A .. '*')

print("NOT testing nested _ENV scope isolation and variable persistence")
...
print("NOT testing constants")
-- TODO: <const> keyword doesn't exist in Luerl (5.4 feature)
--do   -- constants
...
print"NOT testing to-be-closed variables"
-- TODO: <close> keyword doesn't exist in Luerl (5.4 feature)
...
print("NOT testing errors in __close")
--do
--
...
print("NOT testing errors due to non-closable values")
...
print("NOT testing to-be-closed inside close methods")
...
print("NOT testing to-be-closed variables high in the stack")
...
print("NOT testing more closing function tests")
--if rawget(_G, "T") then
--
--  do
--    -- bug in 5.4.3
...
print("NOT testing __close vs. return hooks in Lua functions")
...
print "NOT testing to-be-closed variables in coroutines"
...
print("NOT testing yielding inside closing metamethods while returning")
--do
...
print("NOT testing yielding inside closing metamethods after an error")
--do
...
print("NOT testing errors in coroutines with closing variables")
--do
...
--print("NOT testing suspended coroutine not closing variables when collected")
----local co
----co = coroutine.wrap(function()
----  -- should not run
...
print ("NOT testing to-be-closed variables in generic for loops")
--do
--  local numopen = 0
