...
print("NOT integer testing overflow properties")
...
print("NOT testing NaN")
-- {badarith,'/',[0,0]}
--assert(isNaN(0/0))
--assert(not isNaN(1/0))


print("testing floating point precision limit")
do
...
print("testing types of integers and floats")
...
print("testing basic float notation")
-- basic float notation
assert(0e12 == 0 and .0 == 0 and 0. == 0 and .2e2 == 20 and 2.E-1 == 0.2)

print("string string to number coercion")
do
...
print("testing minus zero as table key")
do
  local x = -1
...
do   -- tests for 'modf'
  ...
  print("NOT testing modf with NaN (division by zero)")
...
print("testing the size of positive and negative math.huge")
assert(math.huge > 10e30)
assert(-math.huge < -10e30)

print("testing integer arithmetic for max/min integers")
-- integer arithmetic
...
print(0 - minint)
print(minint)
print("NOT testing minimum integer overflow")
--assert(0 - minint == minint)
--assert(minint * minint == 0)
--assert(maxint * maxint * maxint == maxint)

print("NOT testing floor division and conversions")
...
print("NOT testing integer NaN and float NaN equivalence")
--assert(1//0.0 == 1/0)
--assert(-1 // 0.0 == -1/0)
print("testing floor division for floats")
assert(eqT(3.5 // 1.5, 2.0))
assert(eqT(3.5 // -1.5, -3.0))

print("testing for different kinds of opcodes")
do   -- tests for different kinds of opcodes
  local x, y 
  print("NOT testing different kinds of opcodes with division by zero")
...
print("testing floor division for max and min integers")
...
print('NOT testing negative exponents')
-- TODO: {badarith,'^',[0,-3]}
-- negative exponents
--do
--  assert(2^-3 == 1 / 2^3)
...
print("testing comparison between floats and integers (border cases)")
...
print("testing order between floats and integers")
...
print("not testing order for NaN")
--do
--  local NaN <const> = 0/0
--  assert(not (NaN < 0))
...
print("not testing error messages at compile time")
...
print("testing 'minint' should be representable as a float no matter the precision")
-- 'minint' should be representable as a float no matter the precision
assert(f2i(minint + 0.0) == minint)


print("testing numeric strings")
...
print("testing literal integer Overflows (new behavior in 5.3.3)")
-- Literal integer Overflows (new behavior in 5.3.3)
do
  print("NOT testing that there are no overflows")
  ...
  print("testing 'tonumber' with overflow by 1")
  ...
  print("NOT testing that hexa format still wraps around")
  -- hexa format still wraps around
  --assert(eqT(tonumber("0x1"..string.rep("0", 30)), 0))

  print("testing lexer in the limits")
  -- lexer in the limits
  assert(minint == load("return " .. minint)())
  assert(eqT(maxint, load("return " .. maxint)()))

  print("NOT testing equality with types for very large and very small numbers")
  --assert(eqT(10000000000000000000000.0, 10000000000000000000000))
  --assert(eqT(-10000000000000000000000.0, -10000000000000000000000))
end


print("testing 'tonumber' coercion")
-- testing 'tonumber'

print("testing 'tonumber' with numbers")
assert(tonumber(3.4) == 3.4)
assert(eqT(tonumber(3), 3))
assert(eqT(tonumber(maxint), maxint) and eqT(tonumber(minint), minint))
print("NOT testing tonumber with NaN")
--assert(tonumber(1/0) == 1/0)

print("testing 'tonumber' with strings")
...
assert(tonumber'+0.01' == 1/100 and tonumber'+.01' == 0.01 and
       ...
       tonumber'+1.' == 1)
print("NOT testing tonumber with invalid scientific notation")
...
print("NOT testing hex string tonumber() in the wrapping case")
--assert(tonumber("0x"..string.rep("f", (intbits//4))) == -1)
--assert(tonumber("-0x"..string.rep("f", (intbits//4))) == 1)
--
-- testing 'tonumber' with base
print("testing 'tonumber' with base")
...
if not _soft then
  ...
  print("testing with very long numerals")
  assert(tonumber("0x"..string.rep("f", 13)..".0") == 2.0^(4*13) - 1)
  assert(tonumber("0x"..string.rep("f", 150)..".0") == 2.0^(4*150) - 1)
  print("NOT testing with 300 character hex number")
  --assert(tonumber("0x"..string.rep("f", 300)..".0") == 2.0^(4*300) - 1)
  print("NOT testing with 500 character hex number")
  --assert(tonumber("0x"..string.rep("f", 500)..".0") == 2.0^(4*500) - 1)
  print("NOT testing 1000 character hex number")
  ...
  print("NOT testing some more long hex numbers")
...
print("testing 'tonumber' for invalid formats")
...
print("NOT testing tonumber('- 0xaa')")
...
print('testing possible confusion with decimal exponent')
-- possible confusion with decimal exponent
assert(0E+1 == 0 and 0xE+1 == 15 and 0xe-1 == 13)


print('testing floating hex numbers')
-- floating hexas
...
print("testing various numerical edge cases")
assert(1.1 == 1.+.1)
...
print("testing basic consistency between integer modulo and float modulo")
...
print("NOT testing precision of module for large numbers")
--TODO: shell hang
...
print("additional modulus tests around min/max integers")
...
print("NOT running non-portable test around NaNs")
...
print("NOT testing unsigned comparisons")
...
print("testing trigonometric and other functions")
...
print("NOT testing math.abs(minint) == minint")
...
do   -- testing floor & ceil
  ...
  print("NOT testing error messages for floor/ceil")
--  checkerror("number expected", math.floor, {})
--  checkerror("number expected", math.ceil, print)
  assert(eqT(math.tointeger(minint), minint))
  assert(eqT(math.tointeger(minint .. ""), minint))
  assert(eqT(math.tointeger(maxint), maxint))
  print("NOT testing tointeger(maxint .. \"\")")
--  assert(eqT(math.tointeger(maxint .. ""), maxint))
  assert(eqT(math.tointeger(minint + 0.0), minint))
  print("NOT testing tointeger(0.0 - minint)")
  --assert(not math.tointeger(0.0 - minint))
  assert(not math.tointeger(math.pi))
  assert(not math.tointeger(-math.pi))
  assert(math.floor(math.huge) == math.huge)
  assert(math.ceil(math.huge) == math.huge)
  print("NOT testing tointeger(math.huge)")
--  assert(not math.tointeger(math.huge))
  ...
  print("NOT testing math.tointeger(0/0)")
  --assert(not math.tointeger(0/0))    -- NaN
end


print("testing fmod for integers")
...
print("NOT testing math.fmod(minint+1, minint) == minint+1")
--assert(eqT(math.fmod(minint + 1, minint), minint + 1))
print("NOT testing math.fmod(maxint-1,maxint) == maxint-1")
--assert(eqT(math.fmod(maxint - 1, maxint), maxint - 1))

print("NOT checking error for math.fmod(3,0)")
--checkerror("zero", math.fmod, 3, 0)


do    -- testing max/min
  print("NOT checking value expected min/max")
...
print("testing implicit conversions")
...
do
  ...
  local z <const> = 0.0
  assert(mz == z)
  print("NOT testing 0 < 1/z where z = 0.0")
  --assert(1/mz < 0 and 0 < 1/z)
  local a = {[mz] = 1}
  assert(a[z] == 1 and a[mz] == 1)
  a[z] = 2
  assert(a[z] == 2 and a[mz] == 2)
  print("NOT testing 'inf'")
-- local inf = math.huge * 2 + 1
-- local mz <const> = -1/inf
-- local z <const> = 1/inf
--  assert(mz == z)
-- assert(1/mz < 0 and 0 < 1/z)
   print("NOT testing various NaN tests")
...
do
  ...
  local rand = random()
  print("NOT testing that the first call of random() is the same as Lua's default for a given seed")
  --assert(eq(rand, 0x0.7a7040a5a323c9d6, 2^-floatbits))
  --assert(rand * 2^floatbits == res)
end

print("NOT testing return of randomseed()")
--TODO: {badarg,randomseed,[]}
--do
...
print("NOT testing random for floats")
--TODO: relies on goto behavior
...
print("NOT testing random for full integers")
--TODO: relies on goto behavior
...
print("NOT testing dice distribution")
--TODO: relies on goto behavior
--do
...
print("testing too many arguments to random")
assert(not pcall(random, 1, 2, 3))    -- too many arguments

-- empty interval
print("testing empty interval to random")
