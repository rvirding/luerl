...
print('testing tail calls x varargs')
...
print('NOT testing C-stack overflow while handling C-stack overflow')
--TODO: shell hang
...
print('NOT testing tail calls x chain of __call')
--TODO: coroutines unimplemented
...
print("NOT testing for generic load")
--TODO: {badarg,load,
--        [{funref,37,[{eref,42},{eref,0}]},
--         <<"modname">>,<<"t">>,
--         {tref,0}]}
...
-- small bug
print("NOT testing bug reading empty chuck")
--local t = {nil, "return ", "3"}
--f, msg = load(function () return table.remove(t, 1) end)
--assert(f() == nil)   -- should read the empty chunk

-- another small bug (in 5.2.1)
print("NOT testing loading binary chunk")
--f = load(string.dump(function () return 1 end), nil, "b", {})
--assert(type(f) == "function" and f() == 1)

print("NOT testing loading a binary long string interupted by GC cycles")
...
print("NOT testing loading binary chunk in text mode")
--TODO: {badarg,dump,[{funref,60,[]}]}
...
print("testing no dump of C functions")
assert(not pcall(string.dump, print))  -- no dump of C functions


print("NOT testing error messages for loader")
--cannotload("unexpected symbol", load(read1("*a = 123")))
--cannotload("unexpected symbol", load("*a = 123"))
--TODO: {badarg,load,[{funref,37,[{eref,0}]}]}
--cannotload("hhi", load(function () error("hhi") end))

print("NOT testing any value is valid for _ENV")
--assert(load("return _ENV", nil, nil, 123)() == 123)


print("NOT testing load when _ENV is not first upvalue")
--local x; XX = 123
--local function h ()
--  local y=x   -- use 'x', so that it becomes 1st upvalue
--  return XX   -- global name
--end
----TODO: {badarg,dump,[{funref,37,[{eref,0}]}]}
...
print("testing generic load with nested functions")
--TODO:  {undefined_function,nil} -- not sure which one
--x = [[
--  return function (x)
--    return function (y)
--     return function (z)
...
print("NOT testing loading a binary chunk with nested functions")
...
print("NOT testing dump/undump with upvalues")
--TODO: {badarg,dump,[{tref,84}]}
--local a, b = 20, 30
...
print("testing dump/undump with many upvalues")
--TODO: {badarg,dump,[{funref,57,[{eref,43}]}]}
--do
...
print("NOT testing binary chunks")
--TODO: string.pack() unimplemented
--do
