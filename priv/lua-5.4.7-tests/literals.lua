...
print("Testing hexadecimal escapes")
assert("\x00\x05\x10\x1f\x3C\xfF\xe8" == "\0\5\16\31\60\255\232")

print("NOT testing lexer handling escape sequences")
...
print("testing whitespace-skipping escapes")
assert("abc\z
        def\z
        ghi\z
       " == 'abcdefghi')
...
print("testing UTF-8 sequences")
assert("\u{0}\u{00000000}\x00\0" == string.char(0, 0, 0, 0))

print("testing limits for 1-byte sequences")
assert("\u{0}\u{7F}" == "\x00\x7F")

print("testing limits for 2-byte sequences")
assert("\u{80}\u{7FF}" == "\xC2\x80\xDF\xBF")

print("testing limits for 3-byte sequences")
assert("\u{800}\u{FFFF}" ==   "\xE0\xA0\x80\xEF\xBF\xBF")

print("NOT testing limits for 4-byte sequences")
--assert("\u{10000}\u{1FFFFF}" == "\xF0\x90\x80\x80\xF7\xBF\xBF\xBF")

print("NOT limits for 5-byte sequences")
--assert("\u{200000}\u{3FFFFFF}" == "\xF8\x88\x80\x80\x80\xFB\xBF\xBF\xBF\xBF")

print("NOT limits for 6-byte sequences")
--assert("\u{4000000}\u{7FFFFFFF}" ==
--       "\xFC\x84\x80\x80\x80\x80\xFD\xBF\xBF\xBF\xBF\xBF")


print("NOT testing error in escape sequences")
...
print("testing valid characters in variable names")
for i = 0, 255 do
...
-- TODO: badarg, format, <<"%p">>
print("NOT testing reuse of long strings")
...
-- TODO: Missing debug.getinfo
print("NOT testing line ends")
--prog = [[
--local a = 1        -- a comment
--local b = 2
--
...
print("NOT testing comments and strings with long brackets")
--local a = [==[]=]==]
--assert(a == "]=")
...
--error error]=]===]
--
print("NOT testing generate all strings of four of these chars")
--local x = {"=", "[", "]", "\n"}
--local len = 4
...
--
--
print("NOT testing decimal point locale")
-- os.setlocale is unimplemented in Luerl
...
print("NOT testing malformed numbers")
