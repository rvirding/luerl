...
print('testing string.byte()/string.char()')
...
print("NOT checking out of range")
-- TODO: Luerl returns "bad argument to 'char'" isntead of "out of range"
...
print('testing string.upper,lower,rep')
...
print("NOT testing overflow in string replacement")
...
print("testing various string.format() cases")
local x = '"ílo"\n\\'
...
do
  ...
  checkQ(math.huge)
  checkQ(-math.huge)
  print("NOT testing 0/0 format")
  --TODO: {badarith, '/', [0,0]}
  --assert(string.format("%q", 0/0) == "(0/0)")   -- NaN
  print("NOT testing string.format on empty table")
  --checkerror("no literal", string.format, "%q", {})
end

assert(string.format("\0%s\0", "\0\0\1") == "\0\0\0\1\0")
print("NOT checking string.format for zeroes")
--TODO: 
--{assert_error,<<"assertion failed">>}
--checkerror("contains zeros", string.format, "%10s", "\0")

-- format x tostring
print("testing string format for spacing")
assert(string.format("%s %s", nil, true) == "nil true")
assert(string.format("%s %.4s", false, true) == "false true")
assert(string.format("%.3s %.3s", false, true) == "fal tru")

print("NOT testing __tostring metamethod")
...
print("testing string.format for hexadecimal and decimal digits")
...
print("NOT testing the longest number that can be formatted")
...
do   -- assume at least 32 bits
  ...
  print("NOT testing that -1 is hex formatted as ffffffff")
  ...
  if max > 2.0^53 then  -- only for 64 bits
    ...
    print("NOT testing that -0x8000000000000000 is 8000000000000000")
...
print("NOT testing 'format %a %A'")
--TODO: {badarg, format, [<<"%a">>,0.1]}
--do
...
print("testing flags required by ISO C..")
...
print('NOT testing string.match(string.format("% 1.0E", 100), "^ 1E%+0+2$"')
--assert(string.match(string.format("% 1.0E", 100), "^ 1E%+0+2$"))
print('NOT testing string.match(string.format("% .1g", 2^10), "^ 1e%+0+3$"')
--assert(string.match(string.format("% .1g", 2^10), "^ 1e%+0+3$"))


-- errors in format

print("NOT testing various format error messages")
...
print("testing various table.concat inputs")
assert(table.concat{} == "")
...
print("NOT testing string formatting with locales")
-- TODO: os.setlocale not implemented
--if not _port then
--
...
-- bug in Lua 5.3.2
print("NOT testing 'gmatch' iterator working across coroutines")
--do
