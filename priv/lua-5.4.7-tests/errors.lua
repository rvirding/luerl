...
print("testing error message with no extra info")
assert(doit("error('hi', 0)") == 'hi')

print("NOT testing error message with no info")
--assert(doit("error()") == nil)


print("test common errors/errors that crashed in the past")
assert(doit("table.unpack({}, 1, n=2^30)"))
print("NOT testing a=math.sin() error message")
...
print("not testing syntax error message")
--checksyntax([[
--  local a = {4
--
...
print("NOT testing errors in goto/break")
...
print("NOT testing better error messages")
--checkmessage("a = {} + 1", "arithmetic")
--print("NOT testing bitwise operation error message")
----checkmessage("a = {} | 1", "bitwise operation")
--print("NOT testing comparison error messages")
----checkmessage("a = {} < 1", "attempt to compare")
----checkmessage("a = {} <= 1", "attempt to compare")
--
--print("NOT testing error messages around calling global val as a function")
----checkmessage("aaa=1; bbbb=2; aaa=math.sin(3)+bbbb(3)", "global 'bbbb'")
--print("NOT testing error messages around undefined method")
----checkmessage("aaa={}; do local aaa=1 end aaa:bbbb(3)", "method 'bbbb'")
--print("NOT testing error messages around undefined field of table")
...
-- calls
print("NOT testing messages for calls")
...
-- tail calls
print("NOT testing messages for tail calls")
...
print("NOT testing upvalues being indexed do not go to the stack")
...
-- short circuit
print("NOT testing short circuit messages")
...
print("NOT testing float-> integer conversions")
--TODO: {badarg,find,[false,<<"local a">>,1,true]} --(below)
--checkmessage("local a = 2.0^100; x = a << 2", "local a")
--TODO: {badarg,find,
--        [false,<<"has no integer representation">>,1,true]} --(below)
...
print("NOT testing type error for an object which is neither in an upvalue nor a register")
...
-- numeric for loops
print("NOT testing error messages for 'for' loops")
...
print('NOT testing passing light userdata instead of full userdata')
--_G.D = debug
--checkmessage([[
--  -- create light udata
...
print('NOT testing messages with named objects')
...
-- global functions
print("NOT testing messages regarding global functions")
--checkmessage("(io.write or print){}", "io.write")
--checkmessage("(collectgarbage or print){}", "collectgarbage")

print("NOT testing errors in functions without debug info")
-- TODO: {badarg, dump, ...}
--do
...
print("testing field accesses after RK limit")
...
--TODO: {illegal_index,nil,<<"create">>}
--checkmessage("string.gsub('s', 's', setmetatable)", "'setmetatable'")

_G.aaa = nil


print("NOT testing errors in coroutines")
...
print("NOT testing size of 'source' info; size of buffer for that info is")
--TODO: {undefiend_method, nil, <<"len">>}
...
print("NOT testing stack overflow")
--TODO: unimplemented debug.getinfo()
--if not _soft then
...
print("NOT testing non string messages")
do
  ---- non string messages
  --local t = {}
...
print("NOT testing xpcall with arguments")
...
print("NOT testing tokens in error messages")
...
print("testing that load() handles syntax errors")
...
print("NOT testing syntax limits")
...
print("NOT testing upvalue limits")
-- upvalues
local lim = 127
...
print("NOT testing local variables limits")
-- local variables
--s = "\nfunction foo ()\n  local "
--for j = 1,300 do
--  s = s.."a"..j..", "
