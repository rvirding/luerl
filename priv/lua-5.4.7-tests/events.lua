...
X = X+10
print("NOT testing custom env with global fallback")
...
print("testing __index metamethod with parent table lookup")
function f (t, i, e)
  assert(not e)
...
print("NOT testing modulus in table")
--assert(a%2 == a); checkcap{"mod", a, 2}
print("NOT testing integer division in table")
...
print('testing rawlen for long strings')
...
print("testing metamethods on t")
...
assert(rawequal(s, s))
print("NOT testing that set == rawset")
--assert(Set{1,3,5,1} == rawSet{3,5,1})
--assert(rawSet{1,3,5,1} == Set{3,5,1})
print("testing set inequality")
assert(Set{1,3,5} ~= Set{3,5,1,6})

-- '__eq' is not used for table accesses
print("testing __eq is not used for table accesses")
t[Set{1,3,5}] = 1
assert(t[Set{1,3,5}] == undef)

print("testing invalidating flags")
...
print("testing string concatination metamethod")
...
print("testing number-table concatination")
c = {}
local x
...
print("testing comparison compatibilities")
local t1, t2, c, d
...
print('testing several levels of calls')
local i
local tt = {
  __call = function (t, ...)
    i = i+1
...
print("testing function calls and global variables")
...
print("NOT testing value of _G.X")
--assert(_G.X == 20)
...
print("testing metatables for basic types")
...
print('NOT testing loops in delegation')
-- TODO: shell hang
...
---- bug in 5.1
print("testing lua 5.1 metamethod chaining bug")
T, K, V = nil
grandparent = {}
