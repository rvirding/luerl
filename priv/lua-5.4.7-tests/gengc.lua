...
print('NOT testing collectgarbage("isrunning")')
...
print('testing that obj is corrected when obj is removed from allgc list')
do
...
print("NOT testing garbage collection bug with coroutines")
...
print("NOT testing weak table GC barrier bug (failed assertion)")
...
print("ensure that userdata barrier evolves correctly")
do
