...
print("making sure table has lots of space in hash part")
for i=1,100 do a[i.."+"] = true end
for i=1,100 do a[i.."+"] = undef end
print("filling hash part with numeric indices testing size operator")
for i=1,100 do
  a[i] = true
  assert(#a == i)
end
...
print("test rehash moving elements from array to hash")
...
print("test iterator function is always the same")
assert(type(ipairs{}) == 'function' and ipairs{} == ipairs{})


print('NOT testing overflow (must wrap-around')
...
print("test size operation on tables with nils")
assert(#{} == 0)
assert(#{nil} == 0)
assert(#{nil, nil} == 0)
...
print("testing next uses always the same iteraction function")
assert(next{} == next{})
...
-- invalid key to 'next'
print("NOT testing invalid key to 'next")
-- TODO: error message is 'nil' instead of 'invalid key'
...
print("NOT testing 'next' with all kinds of keys")
...
print("NOT testing next x GC of deleted keys")
--do
--  -- bug in 5.4.1
...
print('testing table.insert/remove operations')
...
print("NOT testing table library with metamethods")
...
print("NOT testing overflow in table.insert (must wrap-around)")
...
print("testing table iteration with next")
a = {}
for i=1,1000 do
  a[i] = i; a[i - 1] = undef
end
...
print('testing floats in numeric')
do
  local a
  -- integer count
...
print("testing changing control variable")
...
do  -- checking types
  ...
  print('not testing negative float increment')
...
print("testing other strange cases for numeric 'for'")
do   -- testing other strange cases for numeric 'for'
  ...
  print("NOT testing for loop with large step sizes and range")
  ...
  print("NOT testing for loop with negatively large range")
...
print("NOT testing error message on zero step size")
...
print("NOT testing ipairs with metamethods")
--a = {n=10}
...
print("NOT testing yield inside __pairs")
--do
