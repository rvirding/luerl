...
--print"NOT testing stack overflow detection"
...
print("NOT testing stack overflow in message handling")
-- TODO: xpcall unimplemented, hangs if replaced with pcall
--do
--  local count = 0
...
do  print("testing recursion inside pattern matching")
  ...
  local m = f(80)
  assert(#m == 80)
  print("NOT checking error on recursion inside pattern matching")
  -- TODO: Probably not the same error message in Luerl
  --checkerror("too complex", f, 2000)
end


print("NOT testing stack-overflow in recursive 'gsub'")
-- TODO: Hangs shell
--do
--  local count = 0
--  local function foo ()
...
print("NOT testing limits in coroutines inside deep calls")
--do   -- bug in 5.4.0
--  local count = 0
--  local lim = 1000
...
print("NOT testing coroutine chain closure")
--do    -- bug since 5.4.0
--  local count = 0
...
print("NOT testing nesting of resuming yielded coroutines")
--do
--  local count = 0
--
--  local function body ()
...
print("NOT testing nesting coroutines running after recoverable errors")
--do    -- bug in 5.4.2
--  local count = 0
--  local function foo()
--    count = count + 1
