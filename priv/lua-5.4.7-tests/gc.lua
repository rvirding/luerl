...
print("not testing connectgarbage('isrunning')")
...
print("NOT testing changing modes")
...
--
print('NOT testing the "size" of basic GC steps (whatever they mean...)')
--do
--print("steps")
--
--  print("steps (2)")
...
print("NOT testing the pace of the collector")
--if not _port then
...
print("not testing ephemeron behavior")
--local mt = {__mode = 'k'}
...
print("NOT testing __gc x weak tables")
...
print("not testin string keys in weak tables")
...
print("not testing self-referenced threads")
--local thread_id = 0
--local threads = {}
--
...
print("not testing gc with coroutines")
...
print("Not testing GC stop/restart")
--do
--  collectgarbage()
--  collectgarbage"stop"
...
print("not testing creation of an object to be collected when state is closed")
--do
...
-- just to make sure
print('not testing garbe collector state before reentrant test')
--assert(collectgarbage'isrunning')

print("testing that the collector is not reentrant in incremental mode")
