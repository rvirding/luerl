...
It complements built-in Lua functions, making easier common operations on tables, arrays, lists, collections, objects, and a lot more. Tested on Luerl 5.3 this tutorial is copied from [here](https://github.com/Yonaba/Moses/blob/master/doc/tutorial.md).
<br/>
<br/>
