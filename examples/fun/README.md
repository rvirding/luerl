...
local fun = require("fun")
```
__Tested on Luerl 5.3 and everything worked__, this library is something else! check out `luafun-example.lua`, read the original [documentation](https://luafun.github.io/index.html)!
