...
Documentation
-------------
Luerl is implemented as a library, written in clean Erlang/OTP. See the [github wiki page](https://github.com/rvirding/luerl/wiki) for examples & documentation.
